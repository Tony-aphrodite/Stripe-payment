...
$query = "INSERT INTO transacciones_pv (referido,nombre,telefono,email,razon,rfc,direccion,ciudad,estado,cp,e_nombre,e_telefono,e_direccion,e_ciudad,e_estado,e_cp,modelo,color,tpago,tenvio,precio,penvio,total,freg,pedido,vendedor,autorizacion,comentarios) VALUES('$referido','$nombre','$telefono','$email','$razon','$rfc','$direccion','$ciudad','$estado','$cp','$e_nombre','$e_telefono','$e_direccion','$e_ciudad','$e_estado','$e_cp','$modelo','$color','$tpago','$tenvio','$precio','$penvio','$total','$freg','$pedido','$vendedor','$autorizacion','$comentarios') ";
