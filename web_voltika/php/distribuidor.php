...
$cuerpo = '<h3>Contacto en interés de ser distribuidor del sitio web www.voltika.mx con la siguiente información:</h3><br><p>Nombre: <b>'.$nombre.'</b><br>Email: <b>'.$email.'</b><br>Teléfono: <b>'.$telefono.'</b><br>Empresa: <b>'.$empresa.'</b><br><br>Región: <b>'.$region.'</b><br><br>Ganancias anuales promedio: <b>'.$ganancias.'</b><br>Mensaje: <b>'.$mensaje.'</b>';
...
$mail->isHTML(true);
$mail->Subject = 'Interés en ser distribuidor Web Voltika';
$mail->Body = $cuerpo;
$mail->AltBody = $cuerpo;
$mail->send();
